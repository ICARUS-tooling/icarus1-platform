 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus/plugins/de.ims.icarus.plugins.model/test/de/ims/icarus/language/model/test/manifest/PathResolverManifestImplTest.java $
 *
 ...
 * @version $Id: PathResolverManifestImplTest.java 332 2014-12-16 12:55:39Z mcgaerty $
 *
 */
public class PathResolverManifestImplTest extends ManifestTestCase<PathResolverManifestImpl> {

	/**
	 * @see de.ims.icarus.language.model.test.manifest.ManifestTestCase#newInstance()
	 */
	@Override
	protected PathResolverManifestImpl newInstance() {
		return new PathResolverManifestImpl(location, registry);
	}
	...
	public void testTemplate() throws Exception {
		...
		// Prepare template
		PathResolverManifestImpl template = newInstance();
