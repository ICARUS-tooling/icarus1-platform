...
public class WebserviceEditor implements WebserviceEditorExtension, Editor<Webservice> {
	...
	/**
	 * @see net.ikarus_systems.icarus.plugins.weblicht.WebserviceEditorExtension#setAccessType(boolean)
	 */
	@Override
	...
	/**
	 * @see net.ikarus_systems.icarus.plugins.weblicht.WebserviceEditorExtension#getAccessType()
	 */
	@Override
