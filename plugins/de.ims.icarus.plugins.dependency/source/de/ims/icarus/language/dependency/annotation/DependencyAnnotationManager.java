 ...
 *
 */
public class DependencyAnnotationManager extends AbstractSearchAnnotationManager {
	...
	protected long createCompositeHighlight(long[] highlights) {
		return DependencyHighlighting.getInstance().createCompositeHighlight(highlights);
	}
}
