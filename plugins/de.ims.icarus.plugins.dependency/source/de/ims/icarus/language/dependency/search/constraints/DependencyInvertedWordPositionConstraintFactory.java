 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus/plugins/de.ims.icarus.plugins.prosody/source/de/ims/icarus/plugins/prosody/search/constraints/DependencyWordPositionConstraintFactory.java $
 *
 ...
 * @version $Id: DependencyWordPositionConstraintFactory.java 332 2014-12-16 12:55:39Z mcgaerty $
 *
 */
public class DependencyInvertedWordPositionConstraintFactory extends AbstractConstraintFactory {

	public static final String TOKEN = "wordPosInv"; //$NON-NLS-1$

	public DependencyInvertedWordPositionConstraintFactory() {
	...
	public SearchConstraint createConstraint(Object value,
		...
		return new DependencyInverseWordPositionConstraint(value, operator);
	}

	private static class DependencyInverseWordPositionConstraint extends DefaultConstraint {

		private static final long serialVersionUID = 1620252858046735885L;

		public DependencyInverseWordPositionConstraint(Object value, SearchOperator operator) {
		...
		public SearchConstraint clone() {
			return new DependencyInverseWordPositionConstraint(getValue(), getOperator());
		}
	}
}
