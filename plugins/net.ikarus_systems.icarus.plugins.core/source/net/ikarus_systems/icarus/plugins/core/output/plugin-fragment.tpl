<h1><img src='frgmt_obj.gif' />&nbsp;${caption}</h1>
<table>
<tr valign='top'><td><nobr><b>${captionId}:</b></nobr></td><td>${id}</td></tr>
<tr valign='top'><td><nobr><b>${captionPlugin}:</b></nobr></td><td>${plugin}</td></tr>
...
<tr valign='top'><td><nobr><b>${captionPluginVersion}:</b></nobr></td><td>${pluginVersion}</td></tr>
<tr valign='top'><td><nobr><b>${captionMatchingRule}:</b></nobr></td><td>${matchingRule}</td></tr>
...
<table border='1'>
<tr>
	<th width='100'><nobr>${captionIndex}</nobr></th>
	<th><nobr>${captionReference}</nobr></th>
</tr>
§{references}[[
<tr valign='top'>
	<td>${index}</td>
