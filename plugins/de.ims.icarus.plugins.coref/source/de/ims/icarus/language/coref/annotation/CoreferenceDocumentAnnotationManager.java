 ...
 *
 */
public class CoreferenceDocumentAnnotationManager extends AbstractSearchAnnotationManager {

	public CoreferenceDocumentAnnotationManager() {
		// no-op
	}
	...
	public ContentType getAnnotationType() {
		return CoreferenceUtils.getCoreferenceDocumentAnnotationContentType();
	}
	...
	protected long createCompositeHighlight(long[] highlights) {
		return CoreferenceDocumentHighlighting.getInstance().createCompositeHighlight(highlights);
	}
}
