 ...
 *
 */
public class CoreferenceRangeConstraintFactory extends AbstractConstraintFactory {

	public static final String TOKEN = "range"; //$NON-NLS-1$

	public CoreferenceRangeConstraintFactory() {
		super(TOKEN, NODE_CONSTRAINT_TYPE, 
				"plugins.coref.constraints.range.name",  //$NON-NLS-1$
				"plugins.coref.constraints.range.description"); //$NON-NLS-1$
	}
	...
	public SearchConstraint createConstraint(Object value,
		...
		return new CoreferenceRangeConstraint(value, operator);
	}
	...
	private static class CoreferenceRangeConstraint extends DefaultConstraint {

		private static final long serialVersionUID = -229114585478048207L;

		public CoreferenceRangeConstraint(Object value, SearchOperator operator) {
			super(TOKEN, value, operator);
		}

		@Override
		public Object getInstance(Object value) {
			return ((DocumentTargetTree)value).getRange();
		}

		@Override
		public SearchConstraint clone() {
			return new CoreferenceRangeConstraint(getValue(), getOperator());
		}
	}
}
