...
import de.ims.icarus.model.standard.driver.file.ManagedFileResource.Block;
...
public class RUBlockCache implements BlockCache {
	...
	/**
	 * @see de.ims.icarus.model.standard.driver.file.ManagedFileResource.BlockCache#addBlock(de.ims.icarus.model.standard.driver.file.ManagedFileResource.Block, int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.model.standard.driver.file.ManagedFileResource.BlockCache#open(int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.model.standard.driver.file.ManagedFileResource.BlockCache#close()
	 */
	@Override
	public void close() {
		// TODO Auto-generated method stub
