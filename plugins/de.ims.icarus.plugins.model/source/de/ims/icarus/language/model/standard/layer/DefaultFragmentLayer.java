...
public class DefaultFragmentLayer extends DefaultMarkableLayer implements FragmentLayer {
	...
	/**
	 * @see de.ims.icarus.language.model.api.layer.FragmentLayer#getValueLayer()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.api.layer.FragmentLayer#getRasterizer()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.api.layer.FragmentLayer#getRasterSize(de.ims.icarus.language.model.api.Markable, int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.layer.AbstractLayer#getManifest()
	 */
	@Override
