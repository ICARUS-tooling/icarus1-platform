 ...
 *
 */
public class SpanContainer extends AbstractNestedContainer {
	 ...
	 * @param parent
	 */
	public SpanContainer(long id, Container parent, Container base, int startIndex, int endIndex) {
		super(id, parent);
	...
	/**
	 * @see de.ims.icarus.language.model.api.standard.container.AbstractContainer#getBaseContainer()
	 */
	@Override
	...
	public static class SpanContainerBuilder extends AbstractContainerBuilder<SpanContainer> {
		 ...
		 */
		@Override
		protected SpanContainer createContainer() {
			return new SpanContainer(newId(), parent, base, 0, 0);
		}
