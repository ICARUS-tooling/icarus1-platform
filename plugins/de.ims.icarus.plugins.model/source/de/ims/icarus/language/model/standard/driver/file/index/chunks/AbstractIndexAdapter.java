...
public abstract class AbstractIndexAdapter implements ChunkIndexReader, ChunkIndexWriter {
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#isIndexSupported(long)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexReader#getChunkIndex()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#clear()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#open()
	 */
	@Override
