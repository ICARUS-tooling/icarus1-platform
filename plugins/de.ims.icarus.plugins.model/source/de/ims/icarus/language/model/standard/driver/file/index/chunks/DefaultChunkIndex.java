...
import de.ims.icarus.language.model.standard.driver.file.FileSet;
import de.ims.icarus.language.model.standard.driver.file.ManagedFileResource;
import de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkArrays.ArrayAdapter;
...
public class DefaultChunkIndex extends ManagedFileResource implements ChunkIndex {
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndex#getFileSet()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndex#newReader()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndex#newWriter()
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.ManagedFileResource#read(java.lang.Object, java.nio.ByteBuffer)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.ManagedFileResource#write(java.lang.Object, java.nio.ByteBuffer, int)
	 */
	@Override
	...
	/**
	 * @see de.ims.icarus.language.model.standard.driver.file.ManagedFileResource#newBlockData()
	 */
	@Override
	...
	private class Reader implements ChunkIndexReader {
		...
		/**
		 * @see de.ims.icarus.language.model.io.SynchronizedAccessor#getSource()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.io.SynchronizedAccessor#begin()
		 */
		@Override
		public void begin() {
			getReadLock().lock();
		...
		/**
		 * @see de.ims.icarus.language.model.io.SynchronizedAccessor#end()
		 */
		@Override
		public void end() {
			getReadLock().unlock();
		...
		/**
		 * @see de.ims.icarus.language.model.io.SynchronizedAccessor#close()
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexReader#getEntryCount()
		 */
		@Override
		public long getEntryCount() {
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexReader#getFileId(long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexReader#getBeginOffset(long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexReader#getEndOffset(long)
		 */
		@Override
	...
	private class Writer implements ChunkIndexWriter {
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#setFileId(long, int)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#setBeginOffset(long, long)
		 */
		@Override
		...
		/**
		 * @see de.ims.icarus.language.model.standard.driver.file.index.chunks.ChunkIndexWriter#setEndOffset(long, long)
		 */
		@Override
