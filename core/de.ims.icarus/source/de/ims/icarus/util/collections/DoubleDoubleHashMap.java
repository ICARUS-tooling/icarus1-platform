...
public class DoubleDoubleHashMap {
	...
	private static final double DEFAULT_RESULT = -1;
	...
	private static class Entry {
		 ...
		 */
		protected Entry(int hash, double key, double value, Entry next) {
			this.hash = hash;
			this.key = key;
			this.value = value;
			this.next = next;
	 ...
	 */
	public DoubleDoubleHashMap(int initialCapacity, float loadFactor) {
	 ...
	 * 
	 * The value can be retrieved by calling the {@link #get(double)} method with a
