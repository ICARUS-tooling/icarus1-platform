...
public interface ConfigConstants {
	...
	/**
	 * Used for configuring dialogs for file properties. Defines
	 * whether or not a given context accepts regular files.
	 *
	 * The type of this property's value is {@code Boolean}
	 */
	public static final String FILE_TYPE = "fileType"; //$NON-NLS-1$

	/**
	 * Used for configuring dialogs for file properties. Defines
	 * whether or not a given context accepts directory files.
	 *
	 * The type of this property's value is {@code Boolean}
	 */
	public static final String FOLDER_TYPE = "folderType"; //$NON-NLS-1$
