...
//			throw new IllegalArgumentException("Unknown font: "+defaultFont); //$NON-NLS-1$
	...
	public static void buildDefaultFontConfig(ConfigBuilder builder, Font defaultFont) {
		buildDefaultFontConfig(builder, defaultFont.getName());
	}

	public static void buildDefaultFontConfig(ConfigBuilder builder, String defaultFont) {
		buildDefaultFontConfig(builder, defaultFont, 12, Color.black);
	}

	public static void buildDefaultFontConfig(ConfigBuilder builder, String defaultFont, int fontSize, Color fontColor) {
		buildFontFamilyOption(builder, defaultFont);
		builder.addIntegerEntry("fontSize", fontSize, 5, 35); //$NON-NLS-1$
		builder.addColorEntry("fontColor", fontColor.getRGB()); //$NON-NLS-1$
