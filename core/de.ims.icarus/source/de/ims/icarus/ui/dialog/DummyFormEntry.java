 ...
 *
 */
public class DummyFormEntry extends LabeledFormEntry<DummyFormEntry> {

	private final Component[] components;

	public DummyFormEntry(Component...components) {
		this(null, components);
	}

	public DummyFormEntry(String label, Component...components) {
		super(label);

		if (components == null)
			throw new NullPointerException("Invalid components"); //$NON-NLS-1$
	...
	protected void addComponents(FormBuilder builder) {
		for(Component component : components) {
			builder.feedComponent(component);
		}
	}
