...
public class ColumnListHandler extends JPanel implements EntryHandler, 
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#setValue(java.lang.Object)
	 */
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#getValue()
	 */
	@Override
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#getComponent()
	 */
	@Override
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#isValueEditable()
	 */
	@Override
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#isValueValid()
	 */
	@Override
	...
	/**
	 * @see net.ikarus_systems.icarus.config.EntryHandler#newEntry()
	 */
	@Override
