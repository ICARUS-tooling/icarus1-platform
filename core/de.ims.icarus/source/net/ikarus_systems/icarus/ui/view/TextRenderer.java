 ...
 * $URL: https://subversion.assembla.com/svn/icarusplatform/trunk/Icarus/core/net.ikarus_systems.icarus/source/net/ikarus_systems/icarus/ui/view/TextRenderer.java $
 *
...
public class TextRenderer {
	...
	private class EmptyBlock implements Block {
		...
		/**
		 * @see net.ikarus_systems.icarus.ui.view.TextRenderer.Block#getWidth()
		 */
		@Override
		public int getWidth() {
			return width;
		...
		/**
		 * @see net.ikarus_systems.icarus.ui.view.TextRenderer.Block#getHeight()
		 */
		@Override
		public int getHeight() {
			return height;
		...
		/**
		 * @see net.ikarus_systems.icarus.ui.view.TextRenderer.Block#paint(java.awt.Graphics, int, int, int, int)
		 */
		@Override
