...
import de.ims.icarus.model.api.events.CorpusEvent;
...
public class CorpusUndoManager extends UndoManager implements CorpusUndoListener {
	...
	public CorpusUndoManager(Corpus corpus) {
		...
		corpus.addCorpusListener(new CorpusAdapter(){
			...
			/**
			 * @see de.ims.icarus.model.api.events.CorpusAdapter#corpusSaved(de.ims.icarus.model.api.events.CorpusEvent)
			 */
			@Override
	...
	/**
	 * @see de.ims.icarus.model.api.edit.CorpusUndoListener#undoableEditHappened(de.ims.icarus.model.api.edit.UndoableCorpusEdit)
	 */
	@Override
	...
	public void undoableEditHappened(UndoableEditEvent e) {
		throw new UnsupportedOperationException(
				"Use method in de.ims.icarus.model.api.edit.CorpusUndoListener interface"); //$NON-NLS-1$
	}
}
